...
export class NewUserDto {
  ...
  @ApiProperty({ examples: ['193.54.31.63', '54.112.54.87'], required: true })
  @IsNotEmpty()
  @IsIP('4')
  ip: string;
}
...
export class UserDto {
  @ApiProperty({
    examples: ['johndoe@example.com', 'mario@italy.gov.it', 'elon@tesla.com'],
    required: true
  })
  @IsNotEmpty()
  ...
  @ApiProperty({ required: true, description: 'Password of account' })
  @IsNotEmpty()
  password: string;
}
